...
import randomJumpsImg from "../public/random-jumps.jpg";
import noNpmInstallImg from "../public/no-npm-install.jpg";
import portfolioImg from "../public/portfolio-ss.jpg";
